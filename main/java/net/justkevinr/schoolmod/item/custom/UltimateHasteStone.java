...
public class UltimateHasteStone extends Item {
    public UltimateHasteStone(Properties properties) {
        super(properties);
    }
    ...
    public void addInformation(ItemStack p_77624_1_, @Nullable World p_77624_2_,
        ...
        if (Screen.hasShiftDown()){
            tooltip.add(new TranslationTextComponent("tooltip.schoolmod.haste_stone_shift"));
        }else {
            tooltip.add(new TranslationTextComponent("tooltip.schoolmod.haste_stone"));
        }
