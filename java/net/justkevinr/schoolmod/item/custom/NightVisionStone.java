...
public class NightVisionStone extends Item {
    public NightVisionStone(Properties properties) {
        super(properties);
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        if (!worldIn.isRemote()) {
            //20 /200
            playerIn.addPotionEffect(new EffectInstance(Effects.NIGHT_VISION, 1200 , 2));
